...
set logfile logs/rtl2final.lec.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/picosoc -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /pnr_training/WORK_BATCH1/saif_39/final_project/FINAL_PROJECT/rtl/picosoc.v /pnr_training/WORK_BATCH1/saif_39/final_project/FINAL_PROJECT/rtl/picosoc_openram_4bank.v /pnr_training/WORK_BATCH1/saif_39/final_project/FINAL_PROJECT/rtl/simpleuart.v /pnr_training/WORK_BATCH1/saif_39/final_project/FINAL_PROJECT/rtl/picorv32.v /pnr_training/WORK_BATCH1/saif_39/final_project/FINAL_PROJECT/rtl/spimemio.v
elaborate_design -golden -root {picosoc} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/picosoc/fv_map.v.gz
elaborate_design -revised -root {picosoc}
...
#add_name_alias fv/picosoc/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
set_system_mode lec
write_compared_points noneq.compared_points.picosoc.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.picosoc.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.picosoc.rtl.fv_map.rpt
